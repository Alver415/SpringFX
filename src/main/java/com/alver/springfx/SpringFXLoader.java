...
public class SpringFXLoader {
    ...
    public SpringFXLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
                          Callback<Class<?>, Object> controllerFactory, Charset charset,
                          LinkedList<SpringFXLoader> loaders, ApplicationContext applicationContext) {
    ...
    static int compareJFXVersions(String rtVer, String nsVer) {
        ...
        if (rtVer == null || rtVer.isEmpty() ||
                nsVer == null || nsVer.isEmpty()) {
            return retVal;
        }
            ...
            if (isCyclic(SpringFXLoader.this, fxmlLoader)) {
                throw new IOException(
                        String.format(
                                ...
                                SpringFXLoader.this.location.toExternalForm()));
            }
